...
// Path: src/pages/RegisterPage.js
                ...
                <div className="login-page__container__right">
                    ...
                    <div className="d-flex align-items-center flex-column h-max w-max">
                        <div className="mb-auto p-2">
                            <h2 className="text-light">Create new account</h2>
                        </div>
                        <div className="tab-content">
                            <div className="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
                                <form className="login-page__container__right__form" onSubmit={submitHandler}>
                                    ...
                                    <div className="form-outline mb-4">
                                        <input type="password" id="password" value={password} onChange={event => setpassword(event.target.value)} className="form-control" />
                                        <label className="form-label text-light" htmlFor="password">Password</label>
                                    </div>
                                    <div className="mb-auto p-2 w-100">
                                        <button type="submit" className="btn btn-primary rounded text-light">Register</button>
                                    </div>
                                </form>
                            </div>
                        </div>
