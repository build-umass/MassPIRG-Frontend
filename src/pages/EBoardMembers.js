...
const EBoardMembers = () => {
    ...
    return <>
        ...
        <div className="container mb-3">
            ...
            {members.map(member =>
                <Member key={member.id} name={member.name} role={member.role}  classYear={member.classYear} major={member.major} email={member.email} description={member.description} image={member.image} isLoggedIn={isLoggedIn} />
            )}
            {isLoggedIn && (
